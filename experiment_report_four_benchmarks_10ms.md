...
| Benchmark | Condition | Mean tokens | Mean peak KV | Mean peak KV MiB | Mean client CPU | Mean latency |
|---|---|---:|---:|---:|---:|---:|
| MATH | chatbot | 488.7 | 0.433% | 106.34 | 58.31% | 2.650 s |
| MATH | agent | 687.2 | 0.414% | 101.63 | 84.49% | 2.160 s |
| HotpotQA | chatbot | 1,334.8 | 0.952% | 234.01 | 58.68% | 0.263 s |
| HotpotQA | agent | 698.0 | 0.502% | 123.26 | 104.30% | 0.871 s |
| HumanEval | chatbot | 317.0 | 0.283% | 69.50 | 58.68% | 1.203 s |
| HumanEval | reflection agent | 834.4 | 0.459% | 112.88 | 61.35% | 2.676 s |
| WebShop | chatbot | 105.0 | 0.099% | 24.25 | 99.90% | 0.172 s |
| WebShop | iterative agent | 9,354.4 | 1.068% | 262.55 | 74.41% | 1.889 s |
...
CPU follows psutil's convention: 100% is one fully occupied logical core, so
samples can exceed 100%. Observed median CPU intervals were 9.997--9.999 ms across the four benchmarks (p95 10.085--10.304 ms). Polling adds small client overhead. HumanEval
